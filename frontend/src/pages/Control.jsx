        ...
        <div className="control-grid">
          ...
          <div className="control-card">
            <div className="control-card-content">
              ...
              <div className="control-text">
                ...
                <p>6 domains<br/>Sensitivity: <span className="text-orange">Medium</span></p>
              </div>
            </div>
          ...
          <div className="control-card">
            <div className="control-card-content">
              ...
              <div className="control-text">
                <h3>Channels</h3>
                <p>3 active<br/>Email, Slack, Calendar</p>
              </div>
            </div>
            <button className="reset-btn">Reset to default</button>
          </div>
          ...
          <div className="control-card">
            <div className="control-card-content">
              ...
              <div className="control-text">
                ...
                <p>High-impact only<br/>&gt; $2,000 impact</p>
              </div>
            </div>
            <button className="reset-btn">Reset to default</button>
          </div>
          ...
          <div className="control-card">
            <div className="control-card-content">
              ...
              <div className="control-text">
                <h3>Output format</h3>
                <p>Action plan<br/>With owners & dates</p>
              </div>
            </div>
            <button className="reset-btn">Reset to default</button>
          </div>
          ...
          <div className="control-card">
            <div className="control-card-content">
              ...
              <div className="control-text">
                <h3>Model</h3>
                <p>Auto (best available)</p>
                <span className="badge-gray">Advanced users only</span>
              </div>
            </div>
            <button className="reset-btn">Reset to default</button>
          </div>
